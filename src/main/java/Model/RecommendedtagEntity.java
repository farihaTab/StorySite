 ...
 */
@Entity
@Table(name = "RECOMMENDEDTAG", schema = "SDPROJECT", catalog = "")
@IdClass(RecommendedtagEntityPK.class)
public class RecommendedtagEntity {
    ...
    @Id
    @Column(name = "INTERESTEDIN", nullable = false, length = 100)
    ...
    public boolean equals(Object o) {
        ...
        RecommendedtagEntity that = (RecommendedtagEntity) o;
